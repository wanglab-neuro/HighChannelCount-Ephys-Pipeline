function [probeParams,allRecInfo]=GenerateProbeMap_JRC
...
for fileNum=1:size(dataFiles,1)
    ...
    %fprintf(fileID,'dataType = %s\r', 'int16'); older JRC
    fprintf(fileID,'dataTypeRaw = %s\r', 'int16');
    fprintf(fileID,'dataTypeExtracted = %s\r', 'int16');
